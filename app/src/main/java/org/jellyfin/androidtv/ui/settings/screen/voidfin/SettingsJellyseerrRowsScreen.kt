...
fun SettingsJellyseerrRowsScreen() {
	...
	val saveSections = { newSections: List<JellyseerrRowConfig> ->
		...
		jellyseerrPreferences.rowsConfig = newSections
	}
		...
		configurableSections.forEachIndexed { index, section ->
			item(key = section.type) {
				JellyseerrRowRow(
					...
					shouldRequestFocus = section.type == focusedRowType,
...
@Composable
private fun JellyseerrRowRow(
	section: JellyseerrRowConfig,
	canMoveUp: Boolean,
	canMoveDown: Boolean,
